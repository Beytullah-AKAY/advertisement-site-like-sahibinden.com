...
let Üstgövde = ({ oniputchange, hesapadi ,çikişyap}) => {
  ...
  return (
    ...
    >
      ...
      <Grid
        container
        xs={4}
        style={{ backgroundColor: "#3f475f", marginLeft: "100px", display: "flex", width: "100%" }}
      >
        <Grid
          item
          xs={12}
        ...
        >
          <button
            ...
            style={{
              ...
              display: kullanicigririş === "zehra" ? "none" : "flex"
            }}
          ...
          <button
            style={{
              ...
              color: "violet",
              textDecoration: underlinee1,
              display: kullanicigririş === "zehra" ? "flex" : "none"

            }}
            onMouseOver={() => setUnderline1("underline")}
            onMouseOut={() => setUnderline1("none")}
          >
            HOŞGELDİN {kullanicigririş ? kullanicigririş.toUpperCase() : ''}
          </button>
